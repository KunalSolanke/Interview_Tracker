...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.GETALL_INTERVIEW_REQUEST:
      return getInterViewRequest(state, action);
    case actionTypes.GETALL_INTERVIEW_SUCCESS:
      return getInterViewSuccess(state, action);
    case actionTypes.GETCURR_INTERVIEW_REQUEST:
      return getInterViewByIdRequest(state, action);
    case actionTypes.GETCURR_INTERVIEW_SUCCESS:
      return getInterViewByIdSuccess(state, action);
    case actionTypes.GET_COMMENT_REQUEST:
      return getCommentRequest(state, action);
    case actionTypes.GET_COMMENT_SUCCESS:
      return getCommentSuccess(state, action);
    case actionTypes.POST_COMMENT_REQUEST:
      return createCommentRequest(state, action);
    case actionTypes.POST_COMMENT_SUCCESS:
      return createCommentSuccess(state, action);
    case actionTypes.GETTOP_INTERVIEW_REQUEST:
